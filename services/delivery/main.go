...
import (
	...
	"github.com/nndergunov/deliveryApp/pkg/api"
	v1 "github.com/nndergunov/deliveryApp/pkg/api/v1"
	"github.com/nndergunov/deliveryApp/pkg/configreader"
	"github.com/nndergunov/deliveryApp/pkg/grpcserver"
	"github.com/nndergunov/deliveryApp/pkg/logger"
	"github.com/nndergunov/deliveryApp/pkg/server"
	"github.com/nndergunov/deliveryApp/pkg/server/config"
	"github.com/nndergunov/deliveryApp/services/delivery/api/v1/grpc/handler"
	"github.com/nndergunov/deliveryApp/services/delivery/api/v1/rest/handler/deliveryhandler"
	"github.com/nndergunov/deliveryApp/services/delivery/pkg/clients/consumerclient"
	"github.com/nndergunov/deliveryApp/services/delivery/pkg/clients/courierclient"
	"github.com/nndergunov/deliveryApp/services/delivery/pkg/clients/restaurantclient"
	"github.com/nndergunov/deliveryApp/services/delivery/pkg/db"
	"github.com/nndergunov/deliveryApp/services/delivery/pkg/service/deliveryservice"
	"github.com/nndergunov/deliveryApp/services/delivery/pkg/storage/deliverystorage"
)
